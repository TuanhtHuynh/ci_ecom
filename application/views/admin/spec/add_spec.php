...
<div class="form-group row">
  <div class="col-md-3 col-sm-12">
    ...
    <?php endforeach;?>
    <?php echo form_dropdown( 'modelId', $modelOptions, '', 'class="custom-select"' );
?>
  </div>
</div>
<div class="form-group">
  <label>Tên spec</label>
  <input type="text" class="form-control" name="spec_name" value="<?=set_value( 'spec_name' )?>">
  <?=form_error( 'spec_name', '<div class="text-danger">', '</div>' )?>
</div>
<div class="spec_div">
  <div class="form-group add_spec_value_div">
    <?php echo form_input( 'spec_val[]', '', 'class="form-control"' );
?>
    <a class="add_spec_plus btn btn-info" href="javascript:void(0)">
      +
    </a>
  </div>
</div>
